...
In case if you want to run this on a daily basis you can use Azure Devops pipeline to schedule it. Here is a simple example of a pipeline YAML which will run this script every day at 12:00 AM.
